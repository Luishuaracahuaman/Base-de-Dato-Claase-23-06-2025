...
(
	...
	descriptions varchar(2500), --breve descripci�n de carrera
	durations int, --n�mero de ciclos de duraci�n
...
--- 5. Un vendedor o matriculador puede registrar una o muchas matr�culas
ALTER TABLE enrollment
	ADD CONSTRAINT enrollment_seller FOREIGN KEY (seller_code)
	REFERENCES seller (code)
GO

--- 6. Una carrera se puede registrar en una o muchas matr�culas
ALTER TABLE enrollment
	ADD CONSTRAINT enrollment_careers FOREIGN KEY (careers_id)
	REFERENCES careers (id)
GO

--- 7. Una sede puede ser considerada en una o muchas matr�culas
ALTER TABLE enrollment
